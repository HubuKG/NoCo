...
def load_data(logger, args):
    assert args.data_choice in ["DWY", "DBP15K", "FBYG15K", "FBDB15K", "OEA_EN_FR_15K_V1", "OEA_EN_DE_15K_V1",
                                "OEA_D_W_15K_V1", "OEA_D_W_15K_V2"]
    if args.data_choice in ["DWY", "DBP15K", "FBYG15K", "FBDB15K", "OEA_EN_FR_15K_V1", "OEA_EN_DE_15K_V1",
                            "OEA_D_W_15K_V1", "OEA_D_W_15K_V2"]:
