...
class cfg():
    ...
    def get_args(self):
        ...
        # --------- EA -----------
        parser.add_argument("--data_choice", default="DBP15K", type=str, choices=["DBP15K", "DWY", "FBYG15K", "FBDB15K","OEA_EN_FR_15K_V1","OEA_EN_DE_15K_V1","OEA_D_W_15K_V1","OEA_D_W_15K_V2"], help="Experiment path")
        ...
        parser.add_argument("--model_name", default="NoCo", type=str, choices=["EVA", "MCLEA", "MSNEA", "NoCo"], help="model name")
        ...
        # --------- NoCo -----------
        parser.add_argument("--hidden_size", type=int, default=100, help="the hidden size of NoCo")
        parser.add_argument("--intermediate_size", type=int, default=400, help="the hidden size of NoCo")
        parser.add_argument("--num_attention_heads", type=int, default=5, help="the number of attention_heads of NoCo")
        parser.add_argument("--num_hidden_layers", type=int, default=2, help="the number of hidden_layers of NoCo")
